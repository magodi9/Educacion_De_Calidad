...
class User(AbstractBaseUser, PermissionsMixin):
    cedula                   = models.CharField('Cedula', unique=True ,primary_key=True), 
    ...
    departamento             = models.CharField('Deparatamento',max_length=50),    
    municipio_de_residencia  = models.CharField('Municipio de Residencia',max_length=50),
    ...
    REQUIRED_FIELDS = ['cedula', 'password']
